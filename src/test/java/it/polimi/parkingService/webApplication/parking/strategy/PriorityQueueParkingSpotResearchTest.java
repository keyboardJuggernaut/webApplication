...
public class PriorityQueueParkingSpotResearchTest {
    private PriorityQueueParkingSpotResearch researchStrategy;
    private ParkingSpot[][] parkingSpots;
    private SearchCriteria criteria;

    @BeforeEach
    public void setUp() {
        researchStrategy = new PriorityQueueParkingSpotResearch();
